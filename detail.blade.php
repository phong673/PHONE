                                ...
                                <form method="post" id="formCart">
                                    ...
                                    <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
                                        ...
                                        <div class="ratings">
                                            ...
                                            @endfor
                                            @else
                                             <span style="font-size: 12px;color: #a8acaf;">Chưa có đánh giá</span>
                                            @endif
                                            <p class="rating-links"> <a href="#">{{ count($review) }} Đánh giá</a> <span
                                                    class="separator">|</span> <a href="#">Viết đánh giá</a> </p>
                                        </div>
                                                ...
                                                <div class="box-reviews2" >
                                                    ...
                                                    <div class="box visible">
                                                        <ul id="loadReviews">
                                                            ...
                                                            text-align: center;
                                                            color: #cecece;">Không có đánh giá</li>
                                                            @endif  --}}
                                                            {{--  <div class="actions">
                                                                <a class="button view-all"
                                                                    id="revies-button" href="#"><span><span>Xem tất cả</span></span></a>
                                                            </div>  --}}
                                                        </ul>
