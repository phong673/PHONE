                        ...
                        <ul>
                            ...
                            <li data-transition="random">
                                ...
                                <div class="info {{ $row->slider_change == 1 ? 'slide2' : ''}}">
                                    ...
                                    <div class='tp-caption sfb  tp-resizeme ' data-endspeed='500' data-speed='500' data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1'><a href='{{ $row->slider_url }}' class="buy-btn">Mua Ngay</a> </div>
                                </div>
                            </li>
                            @endforeach
                        </ul>
                ...
                <div class="promotion-banner">
                    <div class="row">
                        <div class="col-lg-5 col-sm-5">
                            <a href="#"><img alt=""
                                    src="{{ asset('frontend/images/home-banner1.jpg') }}"></a>
                        </div>
                            ...
                            <div id="testimonials-slider"
                                ...
                                <div class="slider-items slider-width-col4 fadeInUp">
                                    ...
                                    <div class="holder">
                                        ...
                                        <div class="line"></div>
                                        <strong class="name">Thanh Phong</strong>
                                    </div>
                                    <div class="holder">
                                        <div class="thumb"> <img
                                        ...
                                        <div class="line"></div>
                                        <strong class="name">Phương Anh</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
