        ...
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="{{ route('dashboard.index')==$url_canonical ? 'active' : '' }}">
                    <a href="{{route('dashboard.index')}}"><i class="fa fa-th-large"></i> <span class="nav-label">Biểu đồ</span></a>
                </li>
                ...
                <li class="{{ route('category.index')==$url_canonical ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('category.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('category.index') }}">Danh mục</a></li>
                ...
                <li class="{{ route('slider.index')==$url_canonical ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-second-level collapse">
                        <li class="{{ route('slider.index')==$url_canonical ? 'active' : '' }}"><a href="{{ route('slider.index') }}">Danh sách Slider</a></li>
                        @if (route('slider.index')==$url_canonical)
                            <li><a id="add_slider">Thêm Slider</a></li>
                        @endif
                    </ul>
                </li>
                         ...
                         <ul class="sidebar-list">
                             <li>
                                 <a href="#">
                                    ...
                                    <div class="small text-muted m-t-xs">Kết thúc dự án: 16:00 - 06/12/2024</div>
                                 </a>
                             </li>
                             <li>
                                 <a href="#">
                             ...
                             <li>
                                 <a href="#">
                                     ...
                                     <h4>Đã tạo</h4>
                                     <div class="small">Hoàn thành với: 22%</div>
                                     <div class="small text-muted m-t-xs">Kết thúc dự án: 16:00 - 06/12/20224</div>
                                 </a>
                             </li>
                             <li>
                                 <a href="#">
